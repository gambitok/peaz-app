...
Route::group(['middleware' => 'guest', 'namespace' => 'General'], function () {
    ...
    Route::get('login', 'GeneralController@panelLogin')->name('login');
    Route::get('forgot_password', 'GeneralController@panelPassForget')->name('forgot_password');
    Route::post('forgot_password', 'GeneralController@forgetPassword')->name('forgot_password_post');
});

Route::group(['middleware' => 'Is_Admin'], function () {

    Route::get('/', 'General\GeneralController@adminDashboard')->name('dashboard');
    ...
    Route::get('/profile', 'General\GeneralController@getProfile')->name('profile');
    Route::post('/profile', 'General\GeneralController@postProfile')->name('post_profile');
    Route::get('/update_password', 'General\GeneralController@getUpdatePassword')->name('get_update_password');
    Route::post('/update_password', 'General\GeneralController@updatePassword')->name('update_password');
    Route::get('/site_settings', 'General\GeneralController@getSiteSettings')->name('get_site_settings');
    Route::post('/site_settings', 'General\GeneralController@siteSettings')->name('site_settings');
