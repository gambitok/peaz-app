...
<tr>
    ...
    <tr>
        <td style="padding: 5px 45px 25px 45px; font-family: arial; font-size: 15px; color: #333; line-height: normal;"
            width="550">Hello, <strong></strong></td>
    </tr>
    <tr>
        <td style="padding: 0 45px 5px; font-family: arial; font-size: 14px; color: #333; line-height: normal;"
            width="550">We’ve received a request to login  email for  {{site_name}}account.
        </td>
    </tr>
    <tr>
        <td  style="padding: 0 45px 5px; font-family: arial; font-size: 14px; color: #333; line-height: normal;"
