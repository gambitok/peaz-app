...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.post.post_details_update', $data->id) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group mt-4 mb-4">
                            ...
                            <input type="text" class="form-control" id="measurement" name="measurement" value="{{ $data->measurement }}">
                        </div>
