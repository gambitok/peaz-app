                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('admin.dietary.destroy', $dietary['id']) }}" method="POST" style="display:inline;">
                                <a href="{{ route('admin.dietary.show', $dietary['id']) }}" class="btn btn-sm btn-info"><i class="fa fa-eye"></i> Show</a>
                                <a href="{{ route('admin.dietary.edit', $dietary['id']) }}" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i> Edit</a>
                                @csrf
                                @method('DELETE')
