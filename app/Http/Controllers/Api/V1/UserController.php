...
class UserController extends ResponseController
{
    ...
    public function saveUserInterested(Request $request)
    {
        ...
        foreach($request->cuisines_title as $value) {
        ...
        foreach($request->food_and_drink_title as $value) {
            $data = UserInterested::create([
                'user_id'=>$request->user()->id,
                'type'=> 2,
                'title'=> $value,
    ...
    public function userDiet(Request $request)
    {
        ...
        foreach($request->diet_title as $value) {
            $data = UserInterested::create([
                'user_id'=>$request->user()->id,
                'type'=> 3,
                'title'=> $value,
    ...
    public function interestedList(Request $request)
    {
        ...
        $this->sendResponse(200, __('api.suc_interestedlist'), [
            "cuisines"=>$cuisines,
